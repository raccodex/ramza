...
class FunctionsUtils {
    ...
    async Wo_GetReactionsTypes(ctx,type = 'page') {
        ...
        result.forEach(element => {
            ...
            (async () => {
            element.ramza_icon = element.ramza_small_icon = await this.Wo_GetMedia(ctx,element.ramza_icon);
            })();
            element.is_html = 0;
    ...
    async Wo_GetPostReactions(ctx,object_id, col = "post",type = '') {
       ...
       if(reactions && reactions !== undefined){
            ...
            reactions.forEach(element => {
                ...
                if (ctx.reactions_types[element].ramza_small_icon && ctx.reactions_types[element].ramza_small_icon !== undefined && ctx.reactions_types[element].ramza_small_icon != '') {
                    reactions_html += first+"<div class='inline_post_count_emoji reaction'><img src='"+ctx.reactions_types[element].ramza_small_icon+"' alt=\""+ctx.reactions_types[element].name+"\"></div></span>";
                }
