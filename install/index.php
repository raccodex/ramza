...
// +------------------------------------------------------------------------+
// | ramza - The Ultimate PHP Social Networking Platform
// | Copyright (c) 2016 ramza. All rights reserved.
// +------------------------------------------------------------------------+
// MySQL Hostname
$sql_db_host = "'  . $_POST['sql_host'] . '";
// MySQL Database User
    ...
    if ($config_file && $node_file) {
        ...
        if ($query) {
          ...
          $con1 = mysqli_connect($_POST['sql_host'], $_POST['sql_user'], $_POST['sql_pass'], $_POST['sql_name']);
           ...
           $success = 'ramza successfully installed, please wait ..';
        } else {
          $ServerErrors[] = "Error found while installing, please contact us.";
        }
      }
...
<html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
        <title>ramza | Installation</title>
        <link rel="shortcut icon" type="image/png" href="../themes/ramza/img/icon.png"/>
        <link rel="stylesheet" href="../themes/ramza/stylesheet/general-style-plugins.css">
        <link rel="stylesheet" href="style.css">
        <script type="text/javascript" src="../themes/ramza/javascript/jquery-3.1.1.min.js"></script>
    </head>
            ...
            <div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>ramza.sql</td>
                        <td>Required ramza.sql for the installation <small>(Located in ./Script)</small></td>
                    ...
                    <div class="setting-saved-update-alert milinglist"></div>
                                ...
                                <div class="req">
                                    <p>Congratulations! ramza script has been successfully installed and your website is ready.</p>
                  <p>Login to your admin panel to make changes and modify any default content according to your needs.</p>
                  <br>
                  <p>If you have any question, please <a href="mailto:ramzasocial@gmail.com" class="main">let us know</a>.</p>
                                    <br><br>
